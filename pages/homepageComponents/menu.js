    ...
    return (
        <>
            ...
            >
                ...
                {/* Navbar Links */}
                <Navbar.Collapse className="flex flex-col p-4 mt-4 rounded-lg border border-neutral-700 md:flex-row md:space-x-2 md:mt-0 md:text-sm md:font-medium md:border-0 bg-neutral-900 md:bg-transparent max-h-[60vh] overflow-y-auto md:max-h-none md:overflow-y-visible">
                    <Navbar.Link
                        href="#home"
                        className="uppercase block py-1 px-2 text-white rounded hover:bg-neutral-700 md:hover:bg-transparent md:hover:text-red-500 md:p-0 transition-colors duration-300 text-xs md:text-sm"
                    >
                        HOME
                    </Navbar.Link>
                ...
                {/* Join Presale Button */}
                <div className="flex md:order-2 md:ml-4">
                    <a href="#section4">
