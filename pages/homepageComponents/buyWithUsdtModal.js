...
const BuyWithUsdtModal = () => {
  ...
  */
  ...
  useEffect(() => {
    ...
    if (usdtValue <= usdtBalanceOfWalletConnected) {
      ...
      setUsdtInputBoxError(
        <>
          <div className="flex">
            <p className="mt-2 text-sm text-red-600"><span class="font-medium">Oh, snapp!</span> Insufficient USDT Balance.<br />
              Current balance: <span className="font-medium">{usdtBalanceOfWalletConnected}</span> USDT</p>
          </div>
        </>
      );
  ...
  useEffect(() => {
    ...
    if (usdtAllowanceIsLoading || waitForTransactionUsdtAllowanceIsLoading) {
      ...
      setConvertToUsdtInProcessText(
        <>
          <div className="flex items-center justify-center mb-5">
            ...
            <p className="mt-2 text-sm text-green-200"> Please wait, granting allowance of <span class="font-medium">USDT</span>...</p>
          </div>
        </>);
    }
      ...
      setConvertToUsdtInProcessText(
        <>
          <div className="flex items-center justify-center mb-5">
            ...
            <p className="mt-2 text-sm text-green-200"> Please wait, <span class="font-medium">investment</span> in progress...</p>
          </div>
        </>);
    }
      ...
      setConvertToUsdtInProcessText(
        <>
          <div className="flex items-center justify-center mb-5">
            <p className="mt-2 text-sm text-green-200"><span className="font-medium">Congratulations!</span> You're investment was successful. <br />
  ...
  return (
    <>
      <button
        className="bg-red-600 text-white hover:text-white hover:bg-red-700 active:bg-red-900 font-bold uppercase text-base px-8 py-3 rounded-[24px] shadow-md hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
      ...
      {showModal ? (
        <>
          <div className="fixed justify-center items-center z-50 outline-none focus:outline-none">
