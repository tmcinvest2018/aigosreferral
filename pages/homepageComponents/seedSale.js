    ...
    class UserVesting {
        ...
        get HtmlOutput() {
            if (this.userVestingDataLocal) {
                return (
                    <div className="flex items-center p-4 space-x-4 w-full text-white bg-black/40 rounded-lg shadow-lg backdrop-blur-sm border border-white/10">
                        ...
                        <div className="pl-4 text-sm">
                            <p className="font-semibold">You own {new Intl.NumberFormat().format(this.totalAmount)} Token</p>
                            <p className="text-red-400">You're still on time to buy more!</p>
                        </div>
                    </div>
                );
            }
            ...
            setDisplayPresaleData(
                <div className="space-y-4">
                    <div className="w-full bg-gray-700 rounded-full overflow-hidden">
                        <div 
                            className="bg-red-600 text-xs font-medium text-white text-center p-1 rounded-full transition-all duration-500"
                    ...
                    <div className="space-y-2">
                        <p className="text-white text-sm">
                            Tokens Sold: {presaleDataParsed?.tokensSoldParsed || 0} / {presaleDataParsed?.tokensToSellParsed || 0}
                        </p>
                        <p className="text-white text-sm">
                            Funds Raised: {presaleDataParsed?.presaleFundsRaisedParsed || '$0'} / {presaleDataParsed?.preSaleGoalParsed || '$0'}
                        </p>
                    </div>
                </div>
            );
            ...
            setBuyData(
                <div className="space-y-6">
                    <div className="flex justify-center">
                        <svg className="animate-bounce w-16 h-16 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240">
                            <g transform="translate(0,240) scale(0.1,-0.1)" fill="currentColor">
                                <path d="M320 1225 l0 -895 95 0 95 0 0 -117 0 -118 118 118 117 117 683 0 682 0 0 895 0 895 -895 0 -895 0 0 -895z m1195 476 c134 -13 227 -72 280 -177 27 -52 30 -69 30 -149 0 -75 -4 -98 -24 -140 -32 -63 -93 -124 -156 -156 -48 -23 -60 -24 -274 -27 l-224 -3 -169 -165 -169 -164 -106 0 c-80 0 -104 3 -101 13 3 6 81 229 174 494 l169 483 245 -1 c135 0 281 -4 325 -8z" />
                                <path d="M1047 1551 c-3 -9 -48 -137 -101 -286 -53 -148 -96 -277 -96 -285 0 -8 46 31 103 87 58 58 118 109 140 118 30 12 78 15 247 15 235 -1 259 4 307 67 20 26 28 50 31 93 5 72 -16 121 -70 161 -48 34 -76 37 -350 42 -180 3 -207 1 -211 -12z" />
                            </g>
        ...
        <div className="text-center space-y-6">
            <div className="space-y-4">
                ...
                <h3 className="text-white font-bold text-2xl md:text-4xl">
                    1 Token = {presaleDataParsed?.price?.toFixed(4) || '0.0000'}$
                </h3>
